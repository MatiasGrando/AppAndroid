...
object LunchPointProfile : ClientProfile {
    ...
    override val branding: BrandingConfig = BrandingConfig(
        ...
        homeSubtitleRes = R.string.branding_lunch_point_home_subtitle,
        ...
        homeHeroLogoRes = R.drawable.ic_lunch_point_logo,
        loginDecorRes = R.drawable.landing_background,
        homeBackgroundRes = R.drawable.bg_lunch_point_lines,
        confirmationBackgroundRes = R.drawable.bg_lunch_point_surface,
